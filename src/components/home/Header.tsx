      ...
      <article className="px-4 md:px-32 md:w-1/2">
        ...
        <article className="flex flex-col gap-2 justify-center">
          ...
          <h2 className="text-5xl md:text-6xl font-bold">
            Mutare’s Trusted Source for{" "}
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-sky-300 to-blue-700">
              Smartphones
            </span>
          </h2>
          <p className="text-slate-500">
            Whether you’re looking for the latest iPhone, Samsung, or something
            in between, we’ve got it all. No more endless scrolling. Just grab
            your phone, pick a deal, and let us handle the rest. Smart phones
            for smart shoppers, right here in Mutare.
          </p>
        </article>
